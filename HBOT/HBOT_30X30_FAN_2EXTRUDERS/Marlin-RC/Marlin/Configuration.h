...
#define STRING_CONFIG_H_AUTHOR "@PHONGPHU" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EEF   // RAMPS 1.4 (Power outputs: Hotend0, Hotend1, FAN)
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "LYD3D"
...
#define HOTEND_OFFSET_Y {0.0, 17.3}  // (in mm) for each extruder, offset of the hotend on the Y axis
...
//  #define  DEFAULT_bedKd 305.4
  ...
  //#define  DEFAULT_bedKd 1675.16
   ...
   //LYD3D_ALU_M
   #define  DEFAULT_bedKp 484.04
   #define  DEFAULT_bedKi 71.58
...
//
#define Z_PROBE_DEPLOY_HEIGHT 1 // Raise to make room for the probe to deploy / stow
#define Z_PROBE_TRAVEL_HEIGHT 1  // Raise between probing points.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define RIGHT_PROBE_BED_POSITION 200-15-10
    #define FRONT_PROBE_BED_POSITION -40+25+10
    #define BACK_PROBE_BED_POSITION 200-25-10
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,402.6,100}  // default steps per unit for Ultimaker
